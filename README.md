...
**Note**: Remember to update the data file storage path in the configuration file to point to the correct location of your locally stored dataset.The EEG prediction code is still under development and refinement.
